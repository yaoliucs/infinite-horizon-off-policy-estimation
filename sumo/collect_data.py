...
if __name__ == '__main__':
    ...
    seed_base = file_ID * repeat_time + 35200
    ...
    command = [sumoBinary, "-c", "data/grids.sumocfg_{}".format(file_ID), "--xml-validation", "never"]
    ...
    for i in range(repeat_time):
        ...
        for j in range(6):
            if simple:
                ...
                filename = './SASR_data/SASR{}_{}.npy'.format(j, i)
            else:
